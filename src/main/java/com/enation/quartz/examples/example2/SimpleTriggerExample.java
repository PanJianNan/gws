...
package com.enation.quartz.examples.example2;
...
import com.enation.quartz.examples.Logger;
import com.enation.quartz.examples.LoggerFactory;
...
public class SimpleTriggerExample {
  ...
  public void run() throws Exception {
    ...
    trigger = newTrigger().withIdentity("trigger3", "group2").startAt(startTime)
        .withSchedule(simpleSchedule().withIntervalInSeconds(10).withRepeatCount(1)).forJob(job).build();
