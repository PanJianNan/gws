...
//			this.sqlFileExecutor.execute("GO;");
        ...
        sqlFileExecutor.execute("classpath:db_init/eop/eop_mssql.sql");
        sqlFileExecutor.execute("classpath:db_init/javashop/javashop_mssql.sql");
        sqlFileExecutor.execute("classpath:db_init/cms/cms_mssql.sql");
    }
