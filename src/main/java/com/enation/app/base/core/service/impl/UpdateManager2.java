...
public class UpdateManager2 implements IUpdateManager {
	...
	private void exeUpdate(String appid,String version) {
		...
		String updateSql = patchPath + "/db_init/update.sql";
		String cmsUpdateSql = patchPath + "/db_init/cms_update.sql";
	...
	private String getNewVersion(){
		String productid  = EopSetting.PRODUCTID;
		    ...
		    Node productNode  = XMLUtil.getChildByTagName(document, "db_init");
